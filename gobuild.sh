...
imageTag2=hpc-sgp-uat-jcr-aliyun.hik-proconnect.com/docker-ipsc/usta/middleware/loongcollector:3.0.11_t$1

docker build -t $imageTag2  -f tihuan.dockerfile .

#docker tag $imageTag  $imageTag2
